let creatorwrapper = null;
function addNewItem() {
    if(_user_[0]==null){getLogin();return;}
    if (creatorwrapper == null) {
        creatorwrapper = document.createElement("div");
        creatorwrapper.style.display = "none";
        if (window.innerWidth < 600) { creatorwrapper.style.width = "96%"; } else {
            creatorwrapper.style
                .width = "400px";
        }
        creatorwrapper.style.height = "500px";
        creatorwrapper.style.zIndex = "100";
        creatorwrapper.style.width = "450px";
        creatorwrapper.style.overflowY = "hidden";
        creatorwrapper.style.position = "absolute";
        creatorwrapper.style.backgroundColor = "#2E2E2E";
        document.body.appendChild(creatorwrapper);
        ...
        fileUploader.onchange = function () {
            ...
            fr.onload = function () {
                ...
                let im = new Image();
                im.src = fr.result;
                im.onload = function () { dimensions = "," + im.width + "x" + im.height; }
            }
        }
    ...
    darkenBackground(creatorwrapper);
    creatorwrapper.style.left = (window.innerWidth-450)/2+"px";
    creatorwrapper.style.top = window.innerHeight+window.scrollY+"px";
    creatorwrapper.style.display = "block";
    creatorwrapper.style.transition = "all 500ms";
    creatorwrapper.style.top = creatorwrapper.offsetTop-creatorwrapper.offsetHeight+"px";
